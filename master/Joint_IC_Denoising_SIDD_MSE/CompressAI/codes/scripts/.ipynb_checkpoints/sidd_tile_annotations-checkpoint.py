...
annotation_dir = '/mnt/data/caishilv/Data/DIC/annotations'
if not os.path.exists(annotation_dir):
    os.makedirs(annotation_dir)
    print("make dir /mnt/data/caishilv/Data/DIC/annotations")

# prepare for train dataset
data_root = '/mnt/data/caishilv/Data/DIC/SIDD_Medium/combined/SIDD_Medium_Srgb/Data'
train_dict = {}

folders = sorted(os.listdir(data_root))
folders_tqdm = tqdm(folders)
...
data_root = '/mnt/data/caishilv/Data/DIC/SIDD_Benchmark_Data_Blocks/SIDD_Validation'
val_dict = {}
...
data_root = '/mnt/data/caishilv/Data/DIC/SIDD_Benchmark_Data_Blocks/SIDD_Test'
test_dict = {}
