...
val_noisy_blocks_path = '/mnt/data/caishilv/Data/DIC/SIDD_Benchmark/ValidationNoisyBlocksSrgb.mat'
val_noisy_blocks = scipy.io.loadmat(val_noisy_blocks_path)
val_noisy_blocks_numpy = val_noisy_blocks['ValidationNoisyBlocksSrgb']

val_gt_blocks_path = '/mnt/data/caishilv/Data/DIC/SIDD_Benchmark/ValidationGtBlocksSrgb.mat'
val_gt_blocks = scipy.io.loadmat(val_gt_blocks_path)
val_gt_blocks_numpy = val_gt_blocks['ValidationGtBlocksSrgb']

test_noisy_blocks_path = '/mnt/data/caishilv/Data/DIC/SIDD_Benchmark/BenchmarkNoisyBlocksSrgb.mat'
...
val_dir = '/mnt/data/caishilv/Data/DIC/SIDD_Benchmark_Data_Blocks/SIDD_Validation'
test_dir = '/mnt/data/caishilv/Data/DIC/SIDD_Benchmark_Data_Blocks/SIDD_Test'

num_of_scenes = 40
num_of_blocks = 32
scene_names = sorted(os.listdir('/mnt/data/caishilv/Data/DIC/SIDD_Benchmark/SIDD_Benchmark_Data'))
